...
window.addEventListener('DOMContentLoaded', async () => {
    try {
        let res = await axios.get('https://crudcrud.com/api/f8a3c1265751456984243aa3fdad3759/expenseTracker')
    ...
    if (amount.value !== '' && description.value !== '') {
        try {
            ...
            res.data.forEach(async (element) => {
                ...
                if (id === idCeck) {
                    await axios.delete(`https://crudcrud.com/api/f8a3c1265751456984243aa3fdad3759/expenseTracker/${element._id}`)
                    console.log(`deleted id: ${element._id}`)
                    deleteDataFromScreen(id);
                }
            });
            showData(object)
            await axios.post('https://crudcrud.com/api/f8a3c1265751456984243aa3fdad3759/expenseTracker', object)
